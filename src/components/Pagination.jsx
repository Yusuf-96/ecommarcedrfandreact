...
const Pagination = ({
  ...
  return (
    <div className="">
      ...
      <div>
        <nav
          className="relative flex items-center justify-center rounded-md shadow-sm space-x-px"
        ...
        >
          ...
          <div>
            <ul className="flex pl-0 rounded  ">
              <li className=" space-x-px">
                {pageNumbers.map((number, index) => (
                  <button
                    ...
                    className={
                      currentPage === number
                        ? "bg-blue border-red-300 text-red-500 hover:bg-blue-200 relative inline-flex items-center px-4 py-2 rounded border text-sm font-medium"
          ...
          <button
            className={`${
              currentPage !== 1
                ? "disabled shadow-none relative pointer-events-none border px-2 py-2 text-gray-400  rounded-l-md border-gray-300 bg-white"
                : "relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-400 hover:bg-gray-50"
            }`}
            onClick={() => {
              paginateFront();
